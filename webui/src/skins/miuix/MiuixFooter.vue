...
/**
 * A synthetic `target="_blank"` anchor keeps the KernelSU WebView opening the
 * repository externally, which a bare `window.open` does not guarantee.
 */
...
<template>
  <footer class="footer-host">
    <MiuixButton class="footer-btn" @click="openGithub">
